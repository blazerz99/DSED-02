...
namespace DSED_02_Movies
{
    public partial class Form1 : Form
    {
        ...
        private void btnUpdatePrice_Click(object sender, EventArgs e) // doesnt work because for some reason the database hasnt refreshed - I changed data manually in the datbase to make 3 datas in Movies in Year to int without the "aE" stuff
        {
            MyCrud.UpdateMovieFee1();
            MyCrud.UpdateMovieFee2();
